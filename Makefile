...
debootstrap:
	sudo debootstrap $(FOREIGN) --arch=riscv64 \
	--keyring /usr/share/keyrings/debian-ports-archive-keyring.gpg \
	--include=debian-ports-archive-keyring unstable mnt \
...
stage2_qemu:
	...
	sudo cp /usr/bin/qemu-riscv64-static mnt/usr/bin
	sudo chroot mnt /usr/bin/qemu-riscv64-static /bin/bash ./setup.sh
	sudo rm mnt/usr/bin/qemu-riscv64-static
